...
- [Queue Context feedback to Codex](./CODEX.md) — queue human visual feedback into the originating or another recent same-project Codex thread through the local companion.
