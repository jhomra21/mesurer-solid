...
## Stable documentation and parity gate
...
- unresolved upstream product-parity blockers must either be implemented and regression-tested or be explicitly scoped out and disclosed in the public README, changelog/release notes, and parity audit before stable promotion.
...
This check is intentionally done before version-only release preparation. The generated release PR is metadata-only and is not the place to fix stale feature documentation or unresolved source parity.
