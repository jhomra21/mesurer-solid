...
- Codex delivery lifecycle must stay single-flight in the browser, keep hook registration local-process-only, and remove only exact sent annotation ids after a matched completed turn; interruption or uncertain lifecycle state must preserve review evidence;
