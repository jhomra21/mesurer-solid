...
import { installTextEditing as installTextEditingCore } from "./core";
import { installDirectEditContextActionSuppression } from "./context-actions";
import { installTextEditingMeasurementLabelClearance } from "./measurement-label-clearance";
import { installTextEditingPresentation } from "./presentation";
import {
  installMixedInlineTextTargeting,
  installRenderInPlaceTextEditing,
} from "./render-in-place";
import { installDirectEditSelectionChromeOwnership } from "./selection-chrome";
import { installSymmetricMeasurementSpacing } from "./symmetric-measurement-spacing";
import { createTextPresentationPolicyRuntime } from "./presentation-policy";
import { installUnifiedTextInspector } from "./unified-inspector";
import {
  installUnifiedTextSelectEscapeGuard,
  installUnifiedTextSelectLayer,
} from "./unified-select-layer";
import { installUnifiedTextSelectMenus } from "./unified-selects";
