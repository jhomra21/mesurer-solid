...
export function ColorPicker(props: { model: MesurerModel; ownerWindow: Window }) {
  ...
  const samplingMode = () => props.model.state.colorPickerUnsupported ? "dom-fallback" : "native";
